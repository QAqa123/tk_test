...
class Application(object):
    def __init__(self):
        ...
        self.ft = tkFont.Font(size=20, slant=tkFont.ITALIC)
        ...
        self.result_text1 = Text(self.window,background = 'linen')
        # 有色差背景颜色：http://www.science.smith.edu/dftwiki/index.php/Color_Charts_for_TKinter
        ...
        self.result_text = Text(self.window,background = 'light goldenrod')
